.. _doc_creating_2d_particle_system:
...
To get started with particles, the first thing we need to do is add a ``GPUParticles2D``
...
particle effects. Take a look at the documentation for :ref:`particle <doc_2d_particles_properties>` and
