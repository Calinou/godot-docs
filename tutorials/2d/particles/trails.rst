...
system and assign a process material :ref:`as described before <doc_creating_2d_particle_system>`.
...
Assign a new :ref:`Standard Material <doc_standard_material_2d>` to the ``Material``
...
new :ref:`Standard Material <doc_standard_material_2d>` to the ``Material`` property and enable
